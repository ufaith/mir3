...
const
  ...
  GAME_TEXTURE_EQUIP_EFFECT_PART_INT      = 98;
  GAME_TEXTURE_EQUIP_EFFECT_UI            = 'EquipEffect-UI';
  GAME_TEXTURE_EQUIP_EFFECT_UI_INT        = 99;
  GAME_TEXTURE_GROUND                     = 'Ground';
  GAME_TEXTURE_GROUND_INT                 = 100;
  GAME_TEXTURE_PEQUIPH1                   = 'PEquipH1';                 //Pet
  GAME_TEXTURE_PEQUIPH1_INT               = 101;                        //Pet
  GAME_TEXTURE_PEQUIPB1                   = 'PEquipB1';                 //Pet
  GAME_TEXTURE_PEQUIPB1_INT               = 102;                        //Pet                
  { Human Body }
