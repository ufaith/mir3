...
unit mir3_game_sound_engine;

interface

uses
  Windows, Messages, ActiveX, Controls, Classes, SysUtils, StdCtrls,
  mir3_game_engine, mir3_global_config, mir3_game_file_manager_const;
...
uses mir3_game_backend;
  ...
  begin
    ...
    begin
      ...
      ZeroMemory(@FSoundListWWL[0], FFileHeader.ListCount * SizeOf(TSoundListPart)-1);
  ...
  begin  //
    ...
    begin
      ...
      ZeroMemory(@FBGMListWWL[0], FFileHeader.FieldCount * SizeOf(TBGMListPart)-1);
