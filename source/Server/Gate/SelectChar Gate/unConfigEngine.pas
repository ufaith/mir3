...
type
  ...
  public
    property ConfigFile : TConfig_SelectChar_Gate read FConfigFile;
  end;
...
implementation
  ...
  {$REGION ' - TConfigEngine :: Load and Save functions    '}  
    ...
    begin
      ...
      begin
        ...
        try
          ...
          FMem.Position := 0;
          FMem.Read(FConfigFile, sizeOf(TConfig_SelectChar_Gate)); 
    ...
    begin
      FMem := TMemoryStream.Create;
      try
        FMem.Write(FConfigFile, sizeOf(TConfig_SelectChar_Gate));
        FMem.Position := 0;
    ...
    begin
      try
        ZeroMemory(@FConfigFile, sizeOf(TConfig_SelectChar_Gate));
        (* Set Default Values *)
        with FConfigFile do 
        begin
