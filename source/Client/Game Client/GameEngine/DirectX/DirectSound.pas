...
//      ppvAudioPtr2: PPointer; pdwAudioBytes2: PDWORD; dwFlags: DWORD): HResult; stdcall;
    function Lock(dwOffset, dwBytes: LongWord; out ppvAudioPtr1: Pointer; out pdwAudioBytes1: LongWord;
      out ppvAudioPtr2: Pointer; out pdwAudioBytes2: LongWord; dwFlags: LongWord): HResult; stdcall;
   // function Lock(WriteCursor, WriteBytes : LongWord; out AudioPtr1 : Pointer; out AudioBytes1 : LongWord; out AudioPtr2 : Pointer; out AudioBytes2 : LongWord; Flags : LongWord) : HResult; stdcall;
    ...
    function SetFormat(var pcfxFormat: PWaveFormatEx): HResult; stdcall;
